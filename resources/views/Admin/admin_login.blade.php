    ...
    <div class="w-3/4 h-3/4 flex shadow-2xl rounded-3xl ">
        <div class="w-3/12 rounded-tl-3xl rounded-bl-3xl flex-col items-center p-5 relative bg-white">
            ...
            <form action="" method="POST" class="w-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 px-5">
                ...
                <a class="text-[#833ae0] text-center w-full inline-block" href="{{route('teacher.login')}}">Sign in as teacher</a>
            </form>
        </div>
