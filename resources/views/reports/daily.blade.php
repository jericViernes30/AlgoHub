...
<head>
    ...
    <title>Daily Report - {{ now()->format('F d, Y') }}</title>
    <style>
...
<body style="width: 100%; margin: 0 auto;">
    ...
    <div class="header">
        ...
        <div class="subtitle2">Daily Report - {{ now()->format('F d, Y') }}</div>
    </div>

    
    <div class="walkInCountContainer">
        <p class="walkInCount" >Walk in clients today: <span>{{$scheduledCount}}</span></p>
    </div>
